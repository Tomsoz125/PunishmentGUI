...
public class SelectSilent {
    OfflinePlayer target;
    Player executor;
    PunishmentGUI plugin;
    public SelectSilent(OfflinePlayer target, Player executor, PunishmentGUI plugin) {
        this.target=target;
        this.executor=executor;
        this.plugin=plugin;
    }
    public Inventory getInventory() {
        FileConfiguration cfg = plugin.getConfigManager().getSelSilent();
